...
${n.ui.icon(`chevron-${D?`right`:`left`}`)}${r(e.movePrev)}\
</div>\
<div class="k-columnmenu-item k-move-next" tabindex="0" ref="reorder-next">\
${n.ui.icon(`chevron-${D?`left`:`right`}`)}${r(e.moveNext)}\
...
<li class="k-item k-menu-item k-move-prev" ref="reorder-prev"><span class="k-link k-menu-link">${n.ui.icon(`chevron-${D?`right`:`left`}`)}<span class="k-menu-link-text">${r(e.movePrev)}</span></span></li>\
<li class="k-item k-menu-item k-move-next" ref="reorder-next"><span class="k-link k-menu-link">${n.ui.icon(`chevron-${D?`left`:`right`}`)}<span class="k-menu-link-text">${r(e.moveNext)}</span></span></li>`,ce=({messages:e,hasLockableColumns:t,hasStickableColumns:i,reorderable:a})=>`\
...
<li id="${n.guid()}" class="k-item k-listgroup-item k-unstick"><span class="k-link">${n.ui.icon(`unstick`)}<span class="k-item-title">${r(e.unstick)}</span></span></li>`,$=({messages:e})=>`<li id="${n.guid()}" class="k-item k-listgroup-item k-move-prev"><span class="k-link">${n.ui.icon(`chevron-${D?`right`:`left`}`)}<span class="k-item-title">${r(e.movePrev)}</span></span></li>\
<li id="${n.guid()}" class="k-item k-listgroup-item k-move-next"><span class="k-link">${n.ui.icon(`chevron-${D?`left`:`right`}`)}<span class="k-item-title">${r(e.moveNext)}</span></span></li>`,me=({messages:e})=>`<li id="${n.guid()}" class="k-item k-listgroup-item k-filter-item">\
